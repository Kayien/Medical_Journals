...
namespace Medical_Journals_Client.DS_Medical_JournalsTableAdapters {
    ...
    public partial class EditorialsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Medical_Journals_Client.Properties.Settings.Default.MedicalJournalsDBConnectionString;
        }
...
SELECT Id, Name, Description, PublisherId, Price, Editor, EditorialId, CreationDate, CategoryId FROM Journals WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "SELECT Id, Name, Description, PublisherId, Price, Editor, EditorialId, CreationDa" +
                "te, CategoryId FROM dbo.Journals\r\nWHERE Name LIKE @Name AND Description LIKE @De" +
                "scription";
        ...
        public virtual int FillBy(DS_Medical_Journals.JournalsDataTable dataTable, string Name, string Description) {
